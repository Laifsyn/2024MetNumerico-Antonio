...
class MatSup_1(MovingCameraScene):
    ...
    def construct(self):
        ...
        #                     TransformMatchingShapes(last_solution, step),
        #                     desc,
        #                     *animation_list,
        #                     run_time=2,
        #                 ),
        ...
        #             del to_drop, to_shift_again, solution_steps, last_solution

        self.wait(1)

        harmonic_equation = custom_mathtex(
            [
                r"f(t)=",
                r"\frac{1}{2}a_{0}",
                r"+\sum^{\infty}_{n=1}",
        ...
        background.remove(area_1)
        background.remove(area_2)
        self.play(
            AnimationGroup(
                [x.animate.set_opacity(1.0) for x in background],
                harmonic_equation.animate.move_to(DOWN * 2 + LEFT * 3),
                FadeOut(area_2),
        ...
        self.play(
            AnimationGroup([FadeOut(x) for x in [graph, expanded_area, context_text]])
        )
        ...
        self.play(Write(graphed_fourier), Write(fourier_area))
        ...
        self.play(
            AnimationGroup(
                fourier_n.animate(run_time=5).set_value(3),
        ...
        self.play(fourier_n.animate.set_value(120), run_time=3)
